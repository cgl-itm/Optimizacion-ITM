...
|      04       |  **Optimización con restricciones**: Multiplicadores de Lagrange y Condiciones KKT. <br> Examen   |  [YT - Intuition behind the Lagrangian](https://www.youtube.com/watch?v=GR4ff0dTLTw) <br> [Notebook - Optimizacion con restricciones KKT](https://github.com/cgl-itm/Optimizacion-ITM/blob/main/notebooks/06_OptConRestricciones_Lagrange.ipynb)   | 
